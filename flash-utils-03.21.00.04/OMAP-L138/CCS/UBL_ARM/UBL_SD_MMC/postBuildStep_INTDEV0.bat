...
echo HexAIS.exe -ini ..\..\GNU\AISUtils\OMAP-L138-uart.ini -o %PROJECT_ROOT%\ubl_INTDEV0_SDMMC.ais %PROJECT_ROOT%\..\SDMMC\UBL_INTDEV0_SDMMC.out >> temp_postBuildStep_INTDEV0.bat
