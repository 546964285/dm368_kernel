...
echo HexAIS.exe -ini ..\..\GNU\AISUtils\OMAP-L138-uart.ini -o %PROJECT_ROOT%/ubl_AM1808_NAND.ais %PROJECT_ROOT%/../NAND/UBL_AM1808_NAND.out >> temp_postBuildStep_AM1808.bat
