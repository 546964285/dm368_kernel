...
echo HexAIS.exe -ini ..\..\GNU\AISUtils\OMAP-L138-uart.ini -o %PROJECT_ROOT%\ubl_INTDEV0_NOR.ais %PROJECT_ROOT%\..\NOR\UBL_INTDEV0_NOR.out >> temp_postBuildStep_INTDEV0.bat
