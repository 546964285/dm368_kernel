...
echo HexAIS.exe -ini ..\..\GNU\AISUtils\OMAP-L138-uart.ini -o %PROJECT_ROOT%\ubl_INTDEV0_SPI_MEM.ais %PROJECT_ROOT%\..\SPI_MEM\UBL_INTDEV0_SPI_MEM.out >> temp_postBuildStep_INTDEV0.bat
