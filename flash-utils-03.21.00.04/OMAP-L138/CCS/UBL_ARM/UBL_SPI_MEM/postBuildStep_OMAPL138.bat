...
echo HexAIS.exe -ini ..\..\GNU\AISUtils\OMAP-L138-uart.ini -o %PROJECT_ROOT%\ubl_OMAPL138_SPI_MEM.ais %PROJECT_ROOT%\..\SPI_MEM\UBL_OMAPL138_SPI_MEM.out >> temp_postBuildStep_OMAPL138.bat
