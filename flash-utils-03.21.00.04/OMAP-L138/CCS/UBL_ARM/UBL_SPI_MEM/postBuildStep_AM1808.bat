...
echo HexAIS.exe -ini ..\..\GNU\AISUtils\OMAP-L138-uart.ini -o %PROJECT_ROOT%\ubl_AM1808_SPI_MEM.ais %PROJECT_ROOT%\..\SPI_MEM\UBL_AM1808_SPI_MEM.out >> temp_postBuildStep_AM1808.bat
