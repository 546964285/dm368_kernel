...
#ifdef UBL
	#define DEVICE_CONFIG_OPP DEVICE_OPP_1P2V_300MHZ 
...
#define I2C_MEMORYMAP_SPACING   (0x00206000u)
#define DEVICE_I2C_CLK_PRESCALE     (1u) 

#define DEVICE_I2C_CLK_PRESCALE     (1u)  //For 12MHz at 24MHz OSCIN
#define DEVICE_I2C_CLKH             (24u) //For 200kHz at 24MHz OSCIN
#define DEVICE_I2C_CLKL             (24u) //For 200kHz at 24MHz OSCIN

#define DEVICE_I2C_TPS65023_PMIC_SLAVE_ADDR (0x48)
#define DEVICE_I2C_TPS65070_PMIC_SLAVE_ADDR (0x48)
...
#define SDMMC ((DEVICE_SDMMCRegs*) 0x01C40000)
...
#define GPIO0_DIR	(VUint32*)(0x01E26010)
#define GPIO0_SET	(VUint32*)(0x01E26018)
#define GPIO0_CLR	(VUint32*)(0x01E2601C)

typedef struct _DEVICE_OPERATING_POINT
{
  Uint8  opp;
  Uint16 milliVolt;
  Uint16 megaHz;
}
DEVICE_OperatingPoint;
...
extern __FAR__ Uint32  DEVICE_NANDInit (void);
extern __FAR__ Uint32  DEVICE_NORInit (void);
...
extern __FAR__ Uint32 DEVICE_SDMMCInit(Uint8 periphNum);
